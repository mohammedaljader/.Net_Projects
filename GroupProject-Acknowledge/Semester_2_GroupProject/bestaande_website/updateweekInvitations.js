...
//		sendFromAddress = "updateavond@devzone.local"; // DEV
	...
	function getInvitationMailProperties() {
		...
		var title = updateweekProperties.Title,
			...
			body = '<p>Beste collega,</p>';
			body += '<p>Hierbij het verzoek om je in te schrijven voor <b>' + title + ' (vanaf ' + begindatum + ') </b>.</p>';
			body += '<p>Via <a href="' + urlInschrijfFormulier  + '">Inschrijven update weken</a> kun je inschrijven voor alle vrijgegeven update weken.</p>';
			body += '<p style="color:#FF0000";>Wij verzoeken je om voor de 10e van de maand je beschikbaarheid op te geven. Let op wanneer je jezelf inschrijft gaan wij er vanuit dat je beschikbaar bent op die dag/dagen en plannen wij je in wanneer nodig. Eenmaal gepland is afmelden niet meer mogelijk met uitzondering van ziekte of privéomstandigheden.</p>';
			body += '<p>Zodra je ingeschreven bent ontvang je geen reminders meer om in te schrijven voor ' + title + '.</p>';
			body += '<p>Als je je al eerder hebt ingeschreven voor ' + title + ' kun je via deze e-mail je inschrijving checken en eventueel aanpassen.</p>';
			body += '<p>Met vriendeijke groet,</p>';
			body += '<p>Patch Management</p>';
	...
	function getReminderMailProperties() {
		...
		var subject = 'REMINDER: Verzoek inschrijven ' + title,	
			body = '<p>Beste collega,</p>';
			body += '<p>Uit controle is gebleken dat je nog niet gereageerd hebt voor <b>' + title + ' (vanaf ' + begindatum + ') </b>.</p>';
			body += '<p>Via <a href="' + urlInschrijfFormulier  + '">Inschrijven update weken</a> kun je inschrijven voor alle vrijgegeven update weken.</p>';
			body += '<p style="color:#FF0000";>Wij verzoeken je om voor de 10e van de maand je beschikbaarheid op te geven. Let op wanneer je jezelf inschrijft gaan wij er vanuit dat je beschikbaar bent op die dag/dagen en plannen wij je in wanneer nodig. Eenmaal gepland is afmelden niet meer mogelijk met uitzondering van ziekte of privéomstandigheden.</p>';
			body += '<p>Zodra je ingeschreven bent ontvang je geen reminders meer om in te schrijven voor ' + title + '.</p>';
			body += '<p>Met vriendeijke groet,</p>';
